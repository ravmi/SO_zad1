...
_start:
    ...
    ; we read from the file here, zero did not occur yet
    read_chunks_zero_occured_loop:
    ...
    check_if_last_zero:
        cmp r14, 0
        ; means that r14 was cleaned, because zero occured (last segment ended correctly)
